    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" id="now"><a href="" style="color: #495057">ขออนุมัติเดินทาง</a></li>
            </ol>
        </nav>

        <h2 style="color: #495057">ขอใบอนุมัติเดินทาง</h2>
        ...
        <form action="{{ route('savedata') }}" method="POST">
            ...
            <!-- วันที่เดินทาง -->
            <h4 style="color: #495057">ขออนุมัติเดินทาง</h4>
            <div class="row">
                <div class="col-md-4">
            ...
            <h4 style="color: #495057">พาหนะที่ใช้ในการเดินทางไปปฏิบัติงาน</h4>
            <div class="row">
            ...
            <h4 style="color: #495057">ขอพักแรม</h4>
            ...
            <!-- ค่าใช้จ่าย -->
            <h4 style="color: #495057">ค่าใช้จ่ายในการเดินทาง</h4>
            <div class="row">
                <div class="col-md-4">
